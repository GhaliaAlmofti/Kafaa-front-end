  ...
  return (
    <div ref={wrapRef} className="border-t border-gray-200 bg-gray-50/80 px-3 py-3 md:mt-auto">
      <div className="relative">
        ...
        >
          <UserAvatarDisplay photoUrl={user.avatar_url} alt={user.username || 'Account'} />
          <span className="font-bold text-gray-900 text-sm truncate flex-1 min-w-0">{user.username || 'Account'}</span>
          {open ? (
